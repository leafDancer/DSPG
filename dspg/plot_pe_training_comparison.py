...
def write_pe_table_layout_tex(
    ...
    *,
    ...
    lines = [
        ...
        r"% Left table + right figure. In main doc: \input{figures_tables/pe_table_layout.tex}",
        r"% or \graphicspath{{figures_tables/}} so the PDF name resolves.",
...
def main():
    ...
    parser.add_argument(
        ...
        help="Filename written under figures_tables/.",
    )
    parser.add_argument(
        "--table_out",
        type=str,
        default="pe_table.tex",
        help="Standalone LaTeX table under figures_tables/.",
    )
    parser.add_argument(
        "--layout_out",
        type=str,
        default="pe_table_layout.tex",
        help="Left-table right-figure LaTeX snippet under figures_tables/ (uses same PDF as --out).",
    )
    args = parser.parse_args()

    root = REPO_ROOT
    res = root / args.results_dir
    figdir = root / "figures_tables"
